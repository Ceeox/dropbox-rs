...
impl<'a> DropboxFiles<'a>
{
	...
	/// This is an alpha endpoint compatible with the properties API.
	...
	/// Note that this endpoint is part of the properties API alpha and is slightly different from upload.
